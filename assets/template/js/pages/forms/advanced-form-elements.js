$(function () {
    ...
    $demoMaskedInput.find('.time24').inputmask('hh:mm:ss', { placeholder: '__:__:__', alias: 'time24', hourFormat: '24' });

    $demoMaskedInput.find('.time24-costum').inputmask('hh:mm', { placeholder: '__:__', alias: 'time24', hourFormat: '24' });

    //Date Time
    $demoMaskedInput.find('.datetime').inputmask('d/m/y h:s', { placeholder: '__/__/____ __:__', alias: "datetime", hourFormat: '24' });

    //Mobile Phone Number Indonesia
    $demoMaskedInput.find('.mobile-phone-number-id').inputmask('9999999999999', { placeholder: '' });
