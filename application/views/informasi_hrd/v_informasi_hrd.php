        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        <?php echo form_open('informasi/kirim'); ?>
                                    ...
                                    <tbody>
                                        <?php $no = 1; foreach ($q_ks as $row): ?>
                                            <tr>
                                                ...
                                                <td> 
                                                <?php echo anchor('informasi/edit/'.$row->informasi_id, 'EDIT', array('class' => 'btn btn-warning btn-xs waves-effect')); ?>

                                                <?php echo anchor('informasi/delete/'.$row->informasi_id, 'HAPUS', array(
                                                    'class' => 'btn btn-danger btn-xs waves-effect',
                                                    'onclick' => "return confirm('Apakah anda yakin menghapus posisi ".ucwords($row->judul_informasi)." ?');"
                                                )); ?>
                                            </td>
