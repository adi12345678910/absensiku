                    ...
                    <div class="body">
                        <?php foreach ($is_view as $row): ?>
                            <?php if ($row->is_status == 'diterima'): ?>
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-sm-4 col-xs-12">
                                        <center>
                                            <img class="img-responsive thumbnail image-bukti" src="<?php echo base_url('assets/images/sakit/'.$row->is_file); ?>">
                                        </center>
                                    </div>
                            ...
                            <?php elseif ($template_show_role ==  $row->is_user && $row->is_status == 'diteruskan'): ?>
                                ...
                                <?php echo form_open_multipart('sakit/list_pengajuan_update'); ?>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="br_1">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="file" class="form-control font_pengajuan" name="file_image_new" />
                                                        <input type="hidden" name="file_image_old" value="<?php echo $row->is_file; ?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" id="br_1">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-line">
                                                            <textarea class="form-control font_pengajuan" rows="5" name="is_ket" placeholder="Silahkan isi keterangan sakit" required><?php echo ucwords($row->is_ket); ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="modal fade" id="terimaModal" tabindex="-1" role="dialog">
                                <div class="modal-dialog modal-sm" role="document">
                                    <div class="modal-content modal-col-red">
                                        ...
                                        <?php if ($template_show_role == 5  || $template_show_role == 2 || $template_show_role == 3): ?>
                                            <?php echo form_open('sakit/inbox_persetujuan'); ?>
                                    ...
                                    <div class="modal fade" id="terimaModal" tabindex="-1" role="dialog">
                                        <div class="modal-dialog modal-sm" role="document">
                                            <div class="modal-content modal-col-red">
                                                ...
                                                <?php if ($template_show_role == 5  || $template_show_role == 2 || $template_show_role == 3 || $template_show_role == 7 || $template_show_role == 9 || $template_show_role == 11 || $template_show_role == 13): ?>
                                                    <?php echo form_open('sakit/inbox_persetujuan'); ?>
                                                        <div class="modal-body">
                                                            <input type="hidden" name="is_id" value="<?php echo $row->is_id; ?>">
                                                            <input type="hidden" name="is_user" value="<?php echo $row->is_user; ?>">
