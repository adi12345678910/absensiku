                ...
                <div class="card">
                    ...
                    <?php if ($template_show_role == 1 || $template_show_role == 2 || $template_show_role == 3 || $template_show_role == 4 || $template_show_role == 5 || $template_show_role == 6): ?>
                          <div style="margin: 20px 20px;">
                            <a href="<?php echo site_url('izin'); ?>"  class="btn btn-danger"><i class="material-icons long" >add</i><span>Pengajuan</span></a>
                        </div>
                    <?php endif ?>
                            ...
                            <tbody>
                                <?php $no = 1; foreach ($is_view as $row): ?>
                                    <tr>
                                        ...
                                        <td><?php echo ucwords($row->is_ket); ?></td>
                                        <td>
                                        <?php
                                        ...
                                        <td align="center">
                                            ...
                                            <?php 
                                                echo anchor(site_url('izin/list_pengajuan_detail_hrd/'.$row->is_id.'/'.$row->is_user), '<i class="material-icons">search</i>', 
                                                array(
                                            ...
                                            <?php 
                                                echo anchor(site_url('izin/list_pengajuan_detail/'.$row->is_id.'/'.$row->is_user), '<i class="material-icons">search</i>', 
                                                array(
                                                    'class' => 'btn btn-primary btn-xs waves-effect',
                                                    'title' => 'Lihat'
                                                )); 
