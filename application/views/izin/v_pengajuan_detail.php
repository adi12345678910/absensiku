                    ...
                    <div class="body">
                        <?php foreach ($is_view as $row): ?>
                            <?php if ($row->is_status == 'diterima'): ?>
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="bts_view_s">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="bts_view_s">
                                                                <div class="row">
                                                                    <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">Pengajuan</div>
                                                                    <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">: <span class="col-orange"><?php echo ucwords($row->is_status); ?></span></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 col-sm-6 col-xs-12">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="bts_view_s">
                                                        <div class="row">
                                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">Divisi</div>
                                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">: <?php echo ucwords($row->divisi_name); ?></div>
                                                        </div>
                                                    </div><?php endif ?>
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="bts_view_s">
                                                        <div class="row">
                                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">Posisi</div>
                                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">: <?php echo ucwords($row->posisi_name); ?></div>
                                                        </div>
                                                    </div>
                                ...
                                <?php echo form_open_multipart('izin/list_pengajuan_update'); ?>
