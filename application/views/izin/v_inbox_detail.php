                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 col-sm-6 col-xs-12">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="bts_view_s">
                                                            <div class="row">
                                                                <div class="col-lg-5 col-md-5 col-sm-6 col-xs-6">Waktu</div>
                                                        ...
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="bts_view_s">
                                                            <div class="row">
                                                                <div class="col-lg-5 col-md-5 col-sm-6 col-xs-6">Keterangan</div>
                                                                <div class="col-lg-5 col-md-5 col-sm-6 col-xs-6">: <?php echo $row->is_ket; ?></div>
                                                            </div>
                                                        </div>                                                        
                                                    </div>
                                                </div>
