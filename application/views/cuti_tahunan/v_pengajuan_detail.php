                    ...
                    <div class="body">
                        <?php foreach ($is_view as $row): ?>
                            <?php if ($row->is_status == 'diterima'): ?>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="bts_view_s">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-7 col-md-7 col-sm-6 col-xs-6">: <?php echo $row->sisa_cuti; ?> Hari</div>
                                                                </div>
                                                            </div>
                                ...
                                <?php echo form_open_multipart('cuti_tahunan/list_pengajuan_update'); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-sm-3 col-xs-12">
                                    <center>
                                        <img class="img-responsive thumbnail image-bukti" src="<?php echo base_url('assets/images/cuti_tahunan/'.$row->is_file); ?>">
                                    </center>
                                </div>
