                ...
                <div class="card">
                    ...
                    <?php if ($template_show_role == 1 || $template_show_role == 2 || $template_show_role == 3 || $template_show_role == 4|| $template_show_role == 5 || $template_show_role == 6): ?>
                        ...
                        <div style="margin: 20px 20px;">
                            <?php if ($template_show_sisa_cuti == 1 || $template_show_sisa_cuti == 2 || $template_show_sisa_cuti == 3 || $template_show_sisa_cuti == 4|| $template_show_sisa_cuti == 5 || $template_show_sisa_cuti == 6 || $template_show_sisa_cuti == 7 || $template_show_sisa_cuti == 8 || $template_show_sisa_cuti == 9 || $template_show_sisa_cuti == 10 || $template_show_sisa_cuti == 11 || $template_show_sisa_cuti == 12): ?>
                                <a href="<?php echo site_url('cuti_tahunan'); ?>"  class="btn btn-danger"><i class="material-icons long" >add</i><span>Pengajuan</span></a>
                            <?php endif ?>
                            <p style="cursor: default; float:right;"><i class="material-icons long"></i><span class='col-orange'>Sisa Cuti : <?php echo $sisa_cuti; ?></span></p> 
                        </div>
                    <?php endif ?>
                                ...
                                <?php $no = 1; foreach ($is_view as $row): ?>
                                    <tr>
                                        ...
                                        <td align="center">
                                            ...
                                            <?php 
                                                echo anchor(site_url('cuti_tahunan/list_pengajuan_detail_hrd/'.$row->is_id.'/'.$row->is_user), '<i class="material-icons">search</i>', 
                                                array(
                                            ...
                                            <?php 
                                                echo anchor(site_url('cuti_tahunan/list_pengajuan_detail/'.$row->is_id.'/'.$row->is_user), '<i class="material-icons">search</i>', 
                                                array(
                                                    'class' => 'btn btn-primary btn-xs waves-effect',
                                                    'title' => 'Lihat'
                                                )); 
