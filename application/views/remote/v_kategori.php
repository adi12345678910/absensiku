                                ...
                                <table class="table table-bordered table-hover js-basic-example-kategori dataTable font-12">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo anchor('remote/edit/'.$row->kategori_id, 'EDIT', array('class' => 'btn btn-warning btn-xs waves-effect')); ?>

                                                <?php echo anchor('remote/delete/'.$row->kategori_id, 'HAPUS', array(
...
<div class="modal fade" id="largeModal" tabindex="-1" kategori="dialog">
    <div class="modal-dialog modal-lg" kategori="document">
        <div class="modal-content">
            ...
            <?php echo form_open('remote/create'); ?>
                <div class="card">

                    <div class="header">
                        <h2>Tambah Jenis remote</h2>
                    </div>
