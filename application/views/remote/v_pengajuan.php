        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                        ...
                        <ul class="header-dropdown m-r--5">
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu pull-right">
                                    <li>
                                        <a href="<?php echo site_url('remote/kategori'); ?>" >Master Data</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                    ...
                    <div class="body">
                       <?php echo form_open_multipart('remote/pengajuan_remote'); ?>
                            <div class="row font_pengajuan">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" id="br_1">
                                    <div class="form-group">
                                        ...
                                        <div class="form-line">
                                            <textarea class="form-control font_pengajuan" rows="5" name="is_ket" placeholder="Silahkan isi keterangan remote"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-12 col-xs-12">
                                    <a href="<?php echo site_url('remote/list_pengajuan'); ?>" class="btn bg-grey btn-sm waves-effect mr-5"><i class="material-icons long" >subdirectory_arrow_left</i><span>Batal</span></a>
