                    ...
                    <div class="body">
                        <?php foreach ($is_view as $row): ?>
                            <?php if ($row->is_status == 'diterima'): ?>
                                ...
                                <?php echo form_open_multipart('cuti_khusus/list_pengajuan_update'); ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="br_1">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-line">
                                                            <textarea class="form-control font_pengajuan" rows="5" name="is_ket" placeholder="Silahkan isi keterangan izin "><?php echo ucwords($row->is_ket); ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
