...
class M_izin extends CI_Model {
...

	{
		...
		return $this->db->insert('t_izin', $data);
...

	{
		...
		$this->db->join('p_user', 'p_user.user_id=t_izin.user_id');
...

	{
		...
		return $this->db->update('t_izin', $data);
	...
	public function getdata(){
		...
		$query =$this->db->query("SELECT * FROM t_kategori_izin ORDER BY kategori_name ASC");
		return $query->result();
	}
	...
	public function f001_getKategori()
	{
		...
		return $this->db->get('t_kategori_izin');
	}
	...
	public function f003_updateKategori($kategori_id, $data)
	{
		...
		$this->db->where('kategori_id', $kategori_id);
		return $this->db->update('t_kategori_izin', $data);
	}
	
	public function f004_createKategori($data)
	{
		return $this->db->insert('t_kategori_izin', $data);
	}	
	
	private $table = "t_kategori_izin";
