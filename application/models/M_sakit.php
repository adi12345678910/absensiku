...
class M_sakit extends CI_Model {
...

	{
		...
		return $this->db->insert('t_sakit',$data);
...

	{
		...
		$this->db->join('p_user', 'p_user.user_id=t_sakit.user_id');
...

	{
		...
		return $this->db->update('t_sakit', $data);
