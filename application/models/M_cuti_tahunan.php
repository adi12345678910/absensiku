...
class M_cuti_tahunan extends CI_Model {
...

	{
		...
		return $this->db->insert('t_cuti_tahunan', $data);
...

	{
		...
		$this->db->join('p_user', 'p_user.user_id=t_cuti_tahunan.user_id');
...

	{
		...
		$this->db->where_in('is_posisi', array('2','6','8'));
...

	{
		...
		$this->db->where_in('is_posisi', array('10','2'));
...

	{
		...
		return $this->db->update('t_cuti_tahunan', $data1);
	...
	{   
		...
		$query = $this->db->get('t_cuti_tahunan');
